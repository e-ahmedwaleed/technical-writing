...
\subsection{Revising}
Revising is the rearrangement and fine tuning of a fully developed—if not totally completed—draft so that the thesis is aligned with the writer’s purpose. \cite{lumen_course}\\[-1em]
...
Curriculum vitae is a Latin expression which can be loosely translated as $the\ course\ of\ my\ life.$\\[-1em]
